        ...
        <pane size="100">
          <el-col>
            ...
            <el-row :gutter="10" class="mb8">
              ...
              <el-col :span="1.5">
                <el-button type="primary" plain round icon="el-icon-upload2" size="mini" @click="handleImport"
                  v-hasPermi="['system:user:import']">导入</el-button>
              </el-col>
              <el-col :span="1.5">
                <el-button type="primary" plain round icon="el-icon-download" size="mini" @click="handleExport"
            ...
            <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
              ...
              <el-table-column label="操作" align="center" width="200" class-name="mini-padding fixed-width">
                <template slot-scope="scope" v-if="scope.row.userId !== 1">
                  ...
                  <!-- <el-dropdown size="mini" @command="(command) => handleCommand(command, scope.row)"
                    ...
                    <el-dropdown-menu slot="dropdown">
                      ...
                      <el-dropdown-item command="handleAuthRole" icon="el-icon--check"
