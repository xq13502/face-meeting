    ...
    <div class="app-container">
        <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch"
            ...
            <el-form-item label="请假人" prop="userName">
                <el-input v-model="queryParams.userName" placeholder="请输入请假人" clearable
                    @keyup.enter.native="handleQuery" />
            </el-form-item>
            <el-form-item label="请假状态" prop="status">
                <el-select v-model="queryParams.status" placeholder="状态" clearable>
                    <el-option v-for="dict in opetionStatus " :key="dict.value" :label="dict.label"
                        :value="dict.value" />
                </el-select>
            </el-form-item>
        ...
        <el-table v-loading="loading" :data="leaveList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template slot-scope="scope">
                    <el-button v-if="scope.row.userId !== userId" size="mini" type="text"
                        @click="handleUpdate(scope.row)" v-hasPermi="['meeting:leave:edit']">审批</el-button>
...
<script>
    import { getLeaveListById, getLeave, delLeave, addLeave, updateLeave } from "@/api/meeting/leave";
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                getLeaveListById(params).then(response => {
