  ...
  <div class="login">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
      ...
      <el-form-item style="width:100%;">
        <el-button class="btn" :loading="loading" size="medium" type="primary" style="width:100%;"
          @click.native.prevent="handleLogin">
          <span v-if="!loading">登 录</span>
          <span v-else>登 录 中...</span>
        </el-button>
        <div class="other-login">
          <router-link to="/faceLogin" class="face-login-link">
            <el-button @click="handleFaceLogin" type="text">人脸识别登录</el-button>
          </router-link>
