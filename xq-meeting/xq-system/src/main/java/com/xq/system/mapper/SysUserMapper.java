...
public interface SysUserMapper
{
     ...
     * 根据用户编号批量查询用户
     */
    List<SysUser> selectUsersByIds(@Param("meetingId") Long meetingId);

    /**
     * 根据当前用户编号获取人脸图片
     */
    String getUserFaceImage(@Param("userId") Long userId);

    /**
     * 根据用户编号新增人脸图像特征信息
     */
    int updateUserFaceImageById(SysUser sysUser);
}
