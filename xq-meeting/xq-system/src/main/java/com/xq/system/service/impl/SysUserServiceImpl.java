...
import com.xq.common.exception.user.UserException;
import com.xq.system.mapper.*;
...
import com.xq.common.utils.bean.BeanValidators;
import com.xq.common.utils.spring.SpringUtils;
import com.xq.system.domain.SysPost;
...
import com.xq.system.service.ISysDeptService;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public int insertUser(SysUser user) {
        ...
        log.info("--------------------角色ids:{}----------------------", user.getRoleIds()); //5
     ...
     */
    @Override
    public String getUserFaceImage(Long userId) {
        return userMapper.getUserFaceImage(userId);
    }
    ...
    */
    @Override
    public int updateUserFaceImageById(SysUser sysUser) {
        return userMapper.updateUserFaceImageById(sysUser);
    }
